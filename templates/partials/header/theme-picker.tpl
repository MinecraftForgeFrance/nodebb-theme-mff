...
<ul class="navbar-nav me-0 mb-2 mb-lg-0 align-items-center gap-2">
    <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownThemePickerMenu" id="theme-picker">
            <li><a class="dropdown-item" href="#" data-theme="auto"><i class="fa-solid fa-circle-half-stroke"></i>{{tx("theme-mff:theme.auto")}}</a></li>
            <li><a class="dropdown-item" href="#" data-theme="dark"><i class="fa-solid fa-moon"></i>{{tx("theme-mff:theme.dark")}}</a></li>
            <li><a class="dropdown-item" href="#" data-theme="light"><i class="fa-solid fa-sun"></i>{{tx("theme-mff:theme.light")}}</a></li>
        </ul>
    </li>
</ul>
